            ...
            case 'Entregable':
                ...
                function lanzaEntregable() {
                    ...
                    if (elPerfil === 'Participante' || elPerfil === 'Observador') {
                        ...
                        // console.log('arrayMisGrupos.length', arrayMisGrupos[0], arrayMisGrupos[0].split(',').length);
                        for (a = 1; a <= cuantasEntregas; a++) {
                            for (b = 0; b < arrayMisGrupos[0].split(',').length; b++) {
                                // console.log('usuGrupoEntrega.length', thatt['usuGrupoEntrega' + a], arrayMisGrupos[0].split(',')[b]);

                                if (thatt['usuGrupoEntrega' + a] == arrayMisGrupos[0].split(',')[b]) {
                                    elContenido += '<tr>';
                                    elContenido += '<td>';
                                    elContenido += '<p id="usuario_nombre' + a + '" class="usuario_nombre_entrega">' + thatt['usuNombreEntrega' + a] + '</p>';
                                    elContenido += '</td>';
                                    elContenido += '<td>';
                                    elContenido += '<p id="usuario_grupo' + a + '" class="usuario_grupo_entrega">' + thatt['usuGrupoEntrega' + a] + '</p>';
                                    elContenido += '</td>';
                                    elContenido += '<td>';
                                    elContenido += '<p id="fecha_entrega' + a + '" class="fecha_entrega_entrega">' + thatt['fechaEntregada' + a] + '</p>';
                                    elContenido += '</td>';
                                    elContenido += '<td id="recurso_estatus' + a + '" class="recurso_estatus_entrega">';

                                    if (thatt['laTareaRevisada' + a] == false || thatt['laTareaRevisada' + a] == 'false') {
                                        elContenido += '<p class=" ">No revisada</p>';
                                    } else {
                                        if (thatt['laTareaAprobada' + a] == false || thatt['laTareaAprobada' + a] == 'false') {
                                            elContenido += '<p class=" ">No aprobada</p>';
                                        } else {
                                            elContenido += '<p class=" ">Aprobada</p>';
                                        }
                                    }

                                    elContenido += '</td>';
                                    elContenido += '<td id="recurso_calif' + a + '">';

                                    if (thatt['laTareaRevisada' + a] == false || thatt['laTareaRevisada' + a] == 'false') {
                                        elContenido += '<div id="botonCalificarEntrega' + a + '" class="btn btn-round btn-verde2 botonCalificarEntrega" data-toggle="modal" data-target="#modalCalificarEntrega">';
                                        elContenido += '<i class="nc-icon-outline ui-1_pencil" style="padding-right: 10px;"></i>';
                                        elContenido += 'Calificar</div>';
                                    } else {
                                        elContenido += '<div id="botonCalificarEntrega' + a + '" class="btn btn-round btn-azul botonCalificarEntrega" data-toggle="modal" data-target="#modalCalificarEntrega">';
                                        elContenido += '<i class="nc-icon-outline ui-1_pencil" style="padding-right: 10px;"></i>';
                        ...
                        $("#buscadorEntCurso").keyup(function(event) {
                            ...
                            if ($(this).val().length > 2) {
                                ...
                                for (a = 1; a <= cuantasEntregas; a++) {
                                    $('#usuario_nombre' + a).parent().parent().show();
                ...
                function lanzaForo() {
                    ...
                    if (elPerfil === 'Participante' || elPerfil === 'Observador') {
                        ...
                        for (a = 1; a <= cuantasEntregas; a++) {
                            ...
                            elContenido += '           <p id="usuario_nombre' + a + '" class=" ">' + thatt['usuNombreEntrega' + a] + '</p>';
                            elContenido += '     </td>';
                            elContenido += '    <td id="recurso_estatus' + a + '">';

                            if (thatt['laTareaCalificada' + a] == false || thatt['laTareaCalificada' + a] == 'false') {
                            ...
                            if (thatt['laTareaCalificada' + a] == false || thatt['laTareaCalificada' + a] == 'false') {
                                ...
                                elContenido += '        <div class=" ">' + thatt['laTareaCalificada' + a] + '</div>';
                            }
...
function comparaGrupos() {
    ...
    //   TODO ver sólo mis grupos asignados - mejorar lectura
    console.log('comparaGrupos', that['cursoId' + elNumCurso]);

    var ciont = 0;
    if (revisaConexion) {
        firebase.database().ref(laUrlBase + 'Cursos').orderByChild('Id').equalTo(that['cursoId' + elNumCurso]).once('value').then(function(snapshot) {
            snapshot.forEach(function(childSnapshot2) {
                // console.log('childSnapshot2_', childSnapshot2.key, childSnapshot2.child('Asignacion').val());

                childSnapshot2.forEach(function(childSnapshot3) {
                    // console.log('childSnapshot3', childSnapshot3.key);

                    if (childSnapshot3.key == "Asignacion") {
                        // console.log('childSnapshot3.elkey', childSnapshot3.val());

                        childSnapshot3.forEach(function(childSnapshot4) {
                            // console.log('childSnapshot4.elkey', childSnapshot4.val());

                            if (childSnapshot4.key != 'val') {

                                // console.log('childSnapshot4.elval', childSnapshot4.child('Id').val(), usuarioId);

                                if (childSnapshot4.child('Id').val() == usuarioId) {
                                    ciont++;

                                    // console.log('childSnapshot4.yes', childSnapshot4.child('Id').val(), usuarioId);
                                    // console.log('childSnapshot4.yess', childSnapshot4.child('Grupos').val());

                                    arrayMisGrupos[0] = childSnapshot4.child('Grupos').val();
                                    ...
                                    // for (b = 1; b <= arrayUsuariosGrupos_.legnth; b++) {

                                    // console.log('usuGrupoEntrega', thatt['usuGrupoEntrega' + b], arrayUsuariosGrupos[(a - 1)].profesorGrupos.split(',')[a]);
                                    //  if(thatt['usuGrupoEntrega' + a]==){}
                                    // }
...
function lanzamodalCalificarEntrega(cualContenido) {
    ...
    for (a = 1; a <= cuantasEntregas; a++) {
        ...
        if (a == cualContenido) {
            ...
            var usuarioACalifId = thatt['usuIdEntrega' + a];
            ...
            if (elTipoEntregaActual == 1 || elTipoEntregaActual == 3) {
                ...
                elContenido += '<div class="areaComentarios">' + thatt['laTareaComentarios' + a] + '</div>';
                // elContenido += '</div>';
            }
            if (elTipoEntregaActual == 2 || elTipoEntregaActual == 3) {
                // elContenido += '<div class="col-md-4">';
                elContenido += '<br>';
                elContenido += '<button id="botonVerEntregable' + a + '" class="btn btn-azul btn-round ml-auto botonVerEntregable">Ver tarea</button>';
                // elContenido += '</div>';
            }
            // elContenido += '</div>';
            // elContenido += '<div class="titulo_label">';
            ...
            console.log('ok', a, elNumRecurso, thatt['usuIdEntrega' + a], usuarioId, thatt['laTareaLiga' + a]);
            var verEditor = true;

            if (thatt['laTareaRevisada' + a] == false) {
                ...
                elContenido += '<div class="areaComentarios" style="background-color: #ece9ff !important;">' + thatt['laTareaComentariosRetro' + a] + '</div>';
                elContenido += '<br><div class="areaRevisada mb-5">La tarea ha sido revisada y calificada con <b>' + thatt['laTareaCalificion' + a] + '</b>.';
                elContenido += '</div>';
                verEditor = false;
                // } else {
                // }
    ...
    for (a = 1; a <= cuantasEntregas; a++) {
        $('#botonVerEntregable' + a).data('ligaEntrega_', thatt['laTareaLiga' + a]);
...
function eliminarEntregable() {
    console.log('eliminarEntregable');
