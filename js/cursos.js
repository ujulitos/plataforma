        ...
        firebase.database().ref(laUrlBase + 'Cursos').once('value').then(function(snapshot) {
            if (snapshot.val() != null) {
                ...
                snapshot.forEach(function(childSnapshot) {
                    ...
                    console.log('cursoClave ' + contadorCursos + ': ', this['cursoClave' + contadorCursos]);
                    ...
                    console.log('cursoConFechas ' + contadorCursos + ': ', this['cursoConFechas' + contadorCursos]);
                    if (this['cursoConFechas' + contadorCursos] != false) {
                        childSnapshot.forEach(function(childSnapshot2) {
                            if (childSnapshot2.key == "conFechas") {
                                ...
                                console.log('cursoFecha_abre ' + contadorCursos + ': ', this['cursoFecha_abre' + contadorCursos]);
                                this['cursoFecha_cierra' + contadorCursos] = childSnapshot.child(childSnapshot2.key).child('Fecha_cierra').val();
                                console.log('cursoFecha_cierra ' + contadorCursos + ': ', this['cursoFecha_cierra' + contadorCursos]);
                            }
                        });
                    }
                        ...
                        if (childSnapshot2.key == "Asignacion") {
                            ...
                            childSnapshot2.forEach(function(childSnapshot3) {
                                if (childSnapshot3.key != undefined && childSnapshot3.key != null && childSnapshot3.key != '' && childSnapshot3.key != 'undefined' && childSnapshot3.key != 'val') {
                                    ...
                                    // console.log('Curso', contadorCursos, 'UsuAsig', contadorUsuAsigPorCurso, 'Id', this['cursoUsuAsigId' + contadorUsuAsigPorCurso + '_' + contadorCursos]);

                                    this['cursoUsuGrupos' + contadorUsuAsigPorCurso + '_' + contadorCursos] = childSnapshot2.child(childSnapshot3.key).child('Grupos').val();
                                    // console.log('Curso', contadorCursos, 'UsuAsig', contadorUsuAsigPorCurso, 'Grupos', this['cursoUsuGrupos' + contadorUsuAsigPorCurso + '_' + contadorCursos]);

                                    this['cursoUsuClase' + contadorUsuAsigPorCurso + '_' + contadorCursos] = childSnapshot2.child(childSnapshot3.key).child('Clase').val();
                                    // console.log('Curso', contadorCursos, 'UsuAsig', contadorUsuAsigPorCurso, 'Clase', this['cursoUsuClase' + contadorUsuAsigPorCurso + '_' + contadorCursos]);
                                    ...
                                    // console.log('Curso', contadorCursos, 'UsuAsig', contadorUsuAsigPorCurso, 'Fecha_abre', this['cursoUsuFecha_abre' + contadorUsuAsigPorCurso + '_' + contadorCursos]);
                                    ...
                                    // console.log('Curso', contadorCursos, 'UsuAsig', contadorUsuAsigPorCurso, 'Fecha_cierra', this['cursoUsuFecha_cierra' + contadorUsuAsigPorCurso + '_' + contadorCursos]);
                        ...
                        if (childSnapshot2.key == "Temas") {
                            ...
                            childSnapshot2.forEach(function(childSnapshot3) {
                                if (childSnapshot3.key != undefined && childSnapshot3.key != null && childSnapshot3.key != '' && childSnapshot3.key != 'undefined' && childSnapshot3.key != 'val') {
                                    ...
                                    // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Id', this['curso' + contadorCursos + 'TemaId' + contadorTemasPorCurso]);

                                    this['curso' + contadorCursos + 'TemaNombre' + contadorTemasPorCurso] = childSnapshot2.child(childSnapshot3.key).child('Nombre').val();
                                    // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Nombre', this['curso' + contadorCursos + 'TemaNombre' + contadorTemasPorCurso]);
                                    ...
                                    // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Descripcion', this['curso' + contadorCursos + 'TemaDescripcion' + contadorTemasPorCurso]);

                                    // this['curso' + contadorCursos + 'TemaObjetivo' + contadorTemasPorCurso] = childSnapshot2.child(childSnapshot3.key).child('Objetivo').val();
                                    // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Objetivo', this['curso' + contadorCursos + 'TemaObjetivo' + contadorTemasPorCurso]);

                                    this['curso' + contadorCursos + 'TemaOrden' + contadorTemasPorCurso] = childSnapshot2.child(childSnapshot3.key).child('Orden').val();
                                    // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Orden', this['curso' + contadorCursos + 'TemaOrden' + contadorTemasPorCurso]);
                                    ...
                                    childSnapshot3.forEach(function(childSnapshot4) {
                                        ...
                                        if (childSnapshot4.key == "Recursos") {
                                            ...
                                            childSnapshot4.forEach(function(childSnapshot5) {
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Id', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'elRecursoId' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Clave', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'elRecursoClave' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Nombre', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'elRecursoNombre' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Liga', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoLiga' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Categoria', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoCategoria' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'CalifAuto', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoCalifAuto' + contadorRecursosPorTema]);
                                                ...
                                                console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Tipo de Calificacion Tipo', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoTipoCalificacion' + contadorRecursosPorTema + 'Tipo']);
                                                ...
                                                console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Tipo de Calificacion IdRubrica', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoTipoCalificacion' + contadorRecursosPorTema + 'IdRubrica']);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Descripcion', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoDescripcion' + contadorRecursosPorTema]);
                                                // descripción no necesaria
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'TipoDeEntrega', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoTipoEntrega' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Instrucciones', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoInstrucciones' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Orden', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoOrden' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Intentos', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoIntentos' + contadorRecursosPorTema]);
                                                // Intentos no necesarios
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'RecursoVisible', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoVisible' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Obligatorio', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoObligatorio' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'CalifMasAlta', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoCalifMasAlta' + contadorRecursosPorTema]);
                                                // CalifMasAlta no necesaria
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'Promediable', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoPromediable' + contadorRecursosPorTema]);
                                                ...
                                                // console.log('Curso', contadorCursos, 'Tema', contadorTemasPorCurso, 'Recurso', contadorRecursosPorTema, 'PuntosObtener', this['curso' + contadorCursos + 'Tema' + contadorTemasPorCurso + 'RecursoPuntosObtener' + contadorRecursosPorTema]);
...
function pintaCursos() {
    ...
    for (a = 1; a <= cuantosCursosVisibles; a++) {
        ...
        console.log(that['cuantosElemPorCategoria' + a]);
        ...
        firebase.database().ref(laUrlBase + 'Cursos').once('value').then(function(snapshot) {
            if (snapshot.val() != null) {
                ...
                snapshot.forEach(function(childSnapshot) {
                    contadorCursos++;
                    contadorUsuAsig = 0;
                    console.log('contadorCursos', contadorCursos);

                    this['cursoId' + contadorCursos] = snapshot.child(childSnapshot.key).child('Id').val();

                    childSnapshot.forEach(function(childSnapshot2) {
                        if (childSnapshot2.key == "Asignacion") {
                            // console.log('childSnapshot2.key', childSnapshot2.key);
                            childSnapshot2.forEach(function(childSnapshot3) {
                                // if (childSnapshot3.key != undefined && childSnapshot3.key != null && childSnapshot3.key != '' && childSnapshot3.key != 'undefined' && childSnapshot3.key != 'val') {
                                contadorUsuAsig++;
                                // console.log('childSnapshot3.key', contadorUsuAsig, childSnapshot3.key);
                                ...
                                if (elPerfil === 'Participante' || elPerfil === 'Observador' || elPerfil === 'Asesor Académico') {
                                    ...
                                    if (usuarioId == this['cursoUsuAsigId' + contadorUsuAsig]) {
                                        ...
                                        // console.log('ok', contadorCursos, contadorCursosVisibles, this['cursoUsuAsigId' + contadorUsuAsig], 'con el curso', this['cursoId' + contadorCursos]);
...
function activaBotonesCursos() {
    ...
    for (a = 1; a <= cuantosCursos; a++) {
        ...
        $(document).off('click', '#tarjeta' + a + '>.card-img-top').on('click', '#tarjeta' + a + '>.card-img-top',
            function(event) {
                ...
                console.log('elCursoVer', elCursoVer);
    ...
    $(document).off('click', '.botonEliminarContenidoRecurso').on('click', '.botonEliminarContenidoRecurso', function(event) {
        ...
        // console.log('elContenidoRecurso', elContenidoRecurso);
    ...
    $(document).off('click', '#botonInscribirAlumnosTodos').on('click', '#botonInscribirAlumnosTodos', function(event) {
        ...
        console.log('inscribirAlumnosTodos', aInscribirTodos);
    ...
    $(document).off('click', '#botonInscribirProfesoresTodos').on('click', '#botonInscribirProfesoresTodos', function(event) {
        ...
        console.log('inscribirProfesoresTodos', aInscribirTodos);
    ...
    $(document).off('click', '#botonGuardaCurso').on('click', '#botonGuardaCurso', function(event) {
        ...
        console.log('claveCurso', $('#claveCurso').val(), $('#claveCurso').val().length);
        console.log('nombreCurso', $('#nombreCurso').val(), $('#nombreCurso').val().length);
        console.log('descripcionCurso', $('#descripcionCurso').val(), $('#descripcionCurso').val().length);
        console.log('objetivosCurso', $('#editorObjetivos').next().find('.ck-editor__editable').html());
        console.log('temarioCurso', $('#editorTemario').next().find('.ck-editor__editable').html());
        console.log('uploaded-image', $('.uploaded-image>img').attr('src'));
...
function validaErroresCurso() {
    ...
    for (a = 1; a <= cuantosTemas; a++) {
        ...
        console.log('cuantosRecursosPorTema', cuantosRecursosPorTema);

        console.warn('cuantosRecursosPorTema', cuantosRecursosPorTema);
        for (b = 1; b <= cuantosRecursosPorTema; b++) {
            // console.log($('.temas_int > .wrap_tema').eq((a - 1)).find('.temaContenidoBoton').eq((b - 1)).attr('elvalue'));
    ...
    for (a = 1; a <= cuantosTemas; a++) {
        ...
        console.warn('cuantosRecursosPorTema', cuantosRecursosPorTema);
        for (b = 1; b <= cuantosRecursosPorTema; b++) {
            // console.log('qqqqqq', a, b, $('.temas_int > .wrap_tema').eq((a - 1)).find('.temaContenidoBoton').eq((b - 1)).attr('eltipoentrega'));
            // console.log('qqqqqq', a, b, $('.temas_int > .wrap_tema').eq((a - 1)).find('.temaRubrica').eq((b - 1)).hasClass('recurso_deshabilitado'));
            // console.log('qqqqqq', a, b, $('.temas_int > .wrap_tema').eq((a - 1)).find('.temaRubricaBoton').eq((b - 1)).attr('elid'));
            ...
            if ($('.temas_int > .wrap_tema').eq((a - 1)).find('.temaContenidoBoton').eq((b - 1)).attr('eltipoentrega') != 'no') {
                if (!$('.temas_int > .wrap_tema').eq((a - 1)).find('.temaRubrica').eq((b - 1)).hasClass('recurso_deshabilitado')) {
                    // console.log('recurso_habilitado');
    ...
    listaErrores[10] = '';
    console.log('valRestante', valRestante);
    if (valRestante > 0) {
...
function secEditaCurso(cualCurso, cualCursoId) {
    ...
    console.log('secEditaCurso', cursoEditandoNum, cursoEditandoId);
    ...
    console.log('cursoConTemas', cursoConTemas, cuantosTemasCur);
    if (cursoConTemas) {
        var cont = 0;
        var timer = setInterval(function() {
                ...
                for (b = 1; b <= that['cuantosRecursosTemaCurso' + cont]; b++) {
                    // console.log(b, cont, 'cualCurso', cualCurso, 'temaOrden', that['temaOrden' + cont], 'elRecursoNombre', that['curso' + cualCurso + 'Tema' + cont + 'elRecursoNombre' + b]);
                    ...
                    console.log('NombreTemaRecurso', cualCurso, cont, b, that['curso' + cualCurso + 'Tema' + cont + 'elRecursoNombre' + b]);
                    console.log('IdTemaRecurso', cualCurso, cont, b, that['curso' + cualCurso + 'Tema' + cont + 'elRecursoId' + b]);
                    console.log('ClaveTemaRecurso', cualCurso, cont, b, that['curso' + cualCurso + 'Tema' + cont + 'elRecursoClave' + b]);
                    // console.log('califAuto1', cualCurso, cont, b, that['curso' + cualCurso + 'Tema' + cont + 'RecursoCalifAuto' + b]);
                    console.log('TipoCalificacion', cualCurso, cont, b, that['curso' + cualCurso + 'Tema' + cont + 'RecursoTipoCalificacion' + b + 'Tipo']);
                    console.log('TipoCalificacion', cualCurso, cont, b, that['curso' + cualCurso + 'Tema' + cont + 'RecursoTipoCalificacion' + b + 'IdRubrica']);
                    ...
                    if (that['curso' + cualCurso + 'Tema' + cont + 'RecursoTipoCalificacion' + b + 'Tipo'] == 'auto') {
                        ...
                        console.log('IdRubrica', that['curso' + cualCurso + 'Tema' + cont + 'RecursoTipoCalificacion' + b + 'IdRubrica']);
        ...
        firebase.database().ref(laUrlBase + 'Recursos/').orderByKey().equalTo(cualKey).once('value').then(function(snapshot) {
            if (snapshot.val() != null) {
                ...
                snapshot.forEach(function(childSnapshot) {
                    ...
                    // console.log(contadorRubricas, 'rubricaNombre', this['rubricaNombre' + contadorRubricas]);

                    laRubricaId = snapshot.child(childSnapshot.key).child('Id').val();
                    console.log(contadorRubricas, 'rubricaId', laRubricaId);
                    larubricaNombre = snapshot.child(childSnapshot.key).child('Nombre').val();
                    console.log(contadorRubricas, 'rubricaNombre', larubricaNombre);

                    // cuantasRubricas = contadorRubricas;
                });

                console.log('Se han leído todos los keys');
...
function aplicaRubricas(cualNumtema, cualNumRubrica, cualRubricaId, cualRubricaNombre) {
    console.log('aplicaRubricas', cualNumtema, cualNumRubrica, cualRubricaId, cualRubricaNombre);
...
function agregaTema() {
    ...
    for (a = 1; a <= cuantosRecursosCur; a++) {
        if (those['recursoCategoria' + a] != 'Rúbrica 4x4') {
            ...
            // console.log('recDesc', thes['recDesc' + a]);
            // console.log('recInst', thes['recInst' + a]);
        }
    }
    contenidoTema += '      </div>';
    contenidoTema += '  </div>';
    ...
    $(document).off('click', '.temaContenidoItem').on('click', '.temaContenidoItem', function(event) {
        ...
        // console.log('laDesc', itemNum, thes['recDesc' + itemNum]);
        console.log('laInst', itemNum, thes['recInst' + itemNum]);

        console.log('laCat', laCat);
        if (laCat == "Entregable") {
    ...
    $(".buscadorItems").keyup(function(event) {
        ...
        for (b = 1; b <= cuantosRecursosCur; b++) {
            ...
            if ($(this).parent().parent().find('#temaContenidoItem' + b).find('span').html().toLowerCase().includes($(this).val().toLowerCase()) || $(this).parent().parent().find('#temaContenidoItem' + b).find('span').attr('clave').toLowerCase().includes($(this).val().toLowerCase())) {
                console.log('Encontré la palabra_', $(this).val(), 'con el recurso', $(this).parent().find('#temaContenidoItem' + b).find('span').html(), b);
                var cont = b;
        ...
        for (b = 1; b <= cuantosRecursosCur; b++) {
            if (those['recursoCategoria' + b] == 'Rúbrica 4x4') {
                ...
                if ($(this).parent().parent().find('#temaRubricaItem' + b).find('span').html().toLowerCase().includes($(this).val().toLowerCase()) || $(this).parent().parent().find('#temaRubricaItem' + b).find('span').attr('clave').toLowerCase().includes($(this).val().toLowerCase())) {
                    console.log('Encontré la palabra', $(this).val(), 'con el recurso', $(this).parent().find('#temaRubricaItem' + b).find('span').html(), b);
                    var cont = b;
...
function eliminaTema(cualTema) {
    console.log('eliminaTema', cualTema);
...
function agregaContenidoRecurso(cualRowContenido, agregando, categorec) {
    console.log('agregaContenidoRecurso', agregando, categorec);
    ...
    for (a = 1; a <= cuantosRecursosCur; a++) {
        if (those['recursoCategoria' + a] != 'Rúbrica 4x4') {
            ...
            // console.log('recDesc c', thes['recDesc' + a]);
            // console.log('recInst c', thes['recInst' + a]);
        }
    }
    ...
    $(".buscadorItems").keyup(function(event) {
        ...
        for (b = 1; b <= cuantosRecursosCur; b++) {
            $(this).parent().parent().find('#temaContenidoItem' + b).hide();
            if ($(this).parent().parent().find('#temaContenidoItem' + b).find('span').html().toLowerCase().includes($(this).val().toLowerCase()) || $(this).parent().parent().find('#temaContenidoItem' + b).find('span').attr('clave').toLowerCase().includes($(this).val().toLowerCase())) {
                console.log('Encontré la palabra', $(this).val(), 'con el recurso', $(this).parent().find('#temaContenidoItem' + b).find('span').html(), b);
                var cont = b;
                $(this).parent().parent().find('#temaContenidoItem' + cont).show();
            } else {
                console.log('No encontré nada');
...
function activaRadiosCalifica() {
    ...
    // console.log('tipoDeEntrega', tipoDeEntrega);
...
function eliminaContenidoRecurso(cualContenidoRecurso) {
    // console.log('eliminaContenidoRecurso', cualContenidoRecurso);
...
function cuentaUsuariosAsig() {
    console.log('cuentaUsuariosAsig');
    ...
    if (revisaConexion) {
                ...
                snapshot.forEach(function(childSnapshot) {
                    ...
                    if (childSnapshot.key != undefined && childSnapshot.key != null && childSnapshot.key != '' && childSnapshot.key != 'undefined' && childSnapshot.key != 'val') {
                        ...
                        if (snapshot.child(childSnapshot.key).child('Perfil').val() == 'Participante' || snapshot.child(childSnapshot.key).child('Perfil').val() == 'Observador') {
                            ...
                            // console.log(contadorUsuarios, 'usuarioGrupo', this['usuarioGrupo' + contadorUsuarios]);
        ...
        //                 console.log(contadorUsuariosAsignados, 'usuarioAsignadoId', this['usuarioAsignadoId' + contadorUsuariosAsignados]);
        //                 this['usuarioAsignadoFechaAbre' + contadorUsuariosAsignados] = snapshot.child(childSnapshot.key).child('Fecha_abre').val();
        //                 // console.log(contadorUsuariosAsignados, 'usuarioAsignadoFechaAbre', this['usuarioAsignadoFechaAbre' + contadorUsuariosAsignados]);
        //                 this['usuarioAsignadoFechaCierra' + contadorUsuariosAsignados] = snapshot.child(childSnapshot.key).child('Fecha_cierra').val();
        //                 // console.log(contadorUsuariosAsignados, 'usuarioAsignadoFechaCierra', this['usuarioAsignadoFechaCierra' + contadorUsuariosAsignados]);
        ...
        //         console.log('cuantosUsuariosAsignados', cuantosUsuariosAsignados);
...
function cuentaProfesorAsig() {
    console.log('cuentaProfesorAsig');
                ...
                snapshot.forEach(function(childSnapshot) {
                    ...
                    if (childSnapshot.key != undefined && childSnapshot.key != null && childSnapshot.key != '' && childSnapshot.key != 'undefined' && childSnapshot.key != 'val') {
                        ...
                        if (snapshot.child(childSnapshot.key).child('Perfil').val() == 'Asesor Académico') {
                            ...
                            console.log(contadorProfesores, 'usuarioId', this['usuarioId' + contadorProfesores]);
                            this['usuarioNombre' + contadorProfesores] = snapshot.child(childSnapshot.key).child('Nombre').val();
                            console.log(contadorProfesores, 'usuarioNombre', this['usuarioNombre' + contadorProfesores]);
                            this['usuarioApellidoPaterno' + contadorProfesores] = snapshot.child(childSnapshot.key).child('Apellido_Paterno').val();
                            console.log(contadorProfesores, 'ApellidoPaterno', this['usuarioApellidoPaterno' + contadorProfesores]);
                            this['usuarioApellidoMaterno' + contadorProfesores] = snapshot.child(childSnapshot.key).child('Apellido_Materno').val();
                            console.log(contadorProfesores, 'usuarioApellidoMaterno', this['usuarioApellidoMaterno' + contadorProfesores]);
                            this['usuarioCorreo' + contadorProfesores] = snapshot.child(childSnapshot.key).child('Correo').val();
                            console.log(contadorProfesores, 'usuarioCorreo', this['usuarioCorreo' + contadorProfesores]);
                            this['usuarioNivel' + contadorProfesores] = snapshot.child(childSnapshot.key).child('Nivel').val();
                            console.log(contadorProfesores, 'usuarioNivel', this['usuarioNivel' + contadorProfesores]);
                            this['usuarioPerfil' + contadorProfesores] = snapshot.child(childSnapshot.key).child('Perfil').val();
                            console.log(contadorProfesores, 'usuarioPerfil', this['usuarioPerfil' + contadorProfesores]);
                            this['usuarioPuesto' + contadorProfesores] = snapshot.child(childSnapshot.key).child('Puesto').val();
                            console.log(contadorProfesores, 'usuarioPuesto', this['usuarioPuesto' + contadorProfesores]);
                            this['usuarioGrupo' + contadorProfesores] = snapshot.child(childSnapshot.key).child('Grupo').val();
                            console.log(contadorProfesores, 'usuarioGrupo', this['usuarioGrupo' + contadorProfesores]);
                            this['usuarioVisible' + contadorProfesores] = snapshot.child(childSnapshot.key).child('Visible').val();
                            console.log(contadorProfesores, 'usuarioVisible', this['usuarioVisible' + contadorProfesores]);
            ...
            if (snapshot.val() != null) {
                snapshot.forEach(function(childSnapshot) {
                    ...
                    if (childSnapshot.key != undefined && childSnapshot.key != null && childSnapshot.key != '' && childSnapshot.key != 'undefined' && childSnapshot.key != 'val') {
                        ...
                        // console.log(contadorGrupos, 'grupo', this['grupo' + contadorGrupos]);
                ...
                // console.log('arrayGrupos', arrayGrupos);
...
function cuentaProfAsignados() {
    console.log('cuentaProfAsignados');
                    ...
                    if (childSnapshot.key == "Asignacion") {
                        ...
                        childSnapshot.forEach(function(childSnapshot2) {
                            ...
                            if (childSnapshot2.key != undefined && childSnapshot2.key != null && childSnapshot2.key != '' && childSnapshot2.key != 'undefined' && childSnapshot2.key != 'val') {
                                ...
                                // console.log(contadorGrupos, 'profesorId', this['profesorId' + contadorGrupos])
                                this['profesorGrupos' + contadorGrupos] = childSnapshot.child(childSnapshot2.key).child('Grupos').val();
                                // console.log(contadorGrupos, 'profesorGrupos', this['profesorGrupos' + contadorGrupos]);
                                ...
                                // console.log('arrayProfesorGrupos', this['arrayProfesorGrupos' + contadorGrupos]);
                                // console.log('arrayUsuariosGrupos', arrayUsuariosGrupos);
...
function pintaGrupos() {
    console.log('pintaGrupos arrayGrupos', arrayGrupos);
    console.log('pintaGrupos arrayUsuariosGrupos', arrayUsuariosGrupos);
        ...
        for (e = 1; e <= cuantosProfesores; e++) {
            ...
            if (arrayUsuariosGrupos[(c - 1)].profesorId == arrayProfesores[(e - 1)].usuarioId) {
                for (f = 1; f <= cuantosGrupos; f++) {
                    // console.log('iiiiii', $('#botoninscribirProfesor' + (e - 1)).parent().parent().next().next().find('#botonGrupo' + (f - 1)).attr('grupoid'), arrayUsuariosGrupos[(c - 1)].profesorGrupos.split(',')[0]);
                    ...
                    for (g = 0; g < arrayUsuariosGrupos[(c - 1)].profesorGrupos.length; g++) {
                        ...
                        if ($('#botoninscribirProfesor' + (e - 1)).parent().parent().next().next().find('#botonGrupo' + (f - 1)).attr('grupoid') == arrayUsuariosGrupos[(c - 1)].profesorGrupos.split(',')[g]) {
                            ...
                            // console.log('uuuuu', $('#botoninscribirProfesor' + (e - 1)).parent().parent().next().next().find('#botonGrupo' + (f - 1)).attr('grupoid'), arrayUsuariosGrupos[(c - 1)]);
...
function cuentaTemasCur(cualCurso) {
    console.log('cuentaTemasCur', that['cursoId' + cualCurso]);
            ...
            if (snapshot.val() != null) {
                snapshot.forEach(function(childSnapshot) {
                    ...
                    if (childSnapshot.key != undefined && childSnapshot.key != null && childSnapshot.key != '' && childSnapshot.key != 'undefined' && childSnapshot.key != 'val') {
                        ...
                        console.log(contadorTemas, 'temaId', this['temaId' + contadorTemas]);
                        this['temaNombre' + contadorTemas] = snapshot.child(childSnapshot.key).child('Nombre').val();
                        console.log(contadorTemas, 'temaNombre', this['temaNombre' + contadorTemas]);
                        this['temaDescripcion' + contadorTemas] = snapshot.child(childSnapshot.key).child('Descripcion').val();
                        console.log(contadorTemas, 'temaDescripcion', this['temaDescripcion' + contadorTemas]);
                        this['temaObjetivo' + contadorTemas] = snapshot.child(childSnapshot.key).child('Objetivo').val();
                        console.log(contadorTemas, 'temaObjetivo', this['temaObjetivo' + contadorTemas]);
                        this['temaOrden' + contadorTemas] = snapshot.child(childSnapshot.key).child('Orden').val();
                        console.log(contadorTemas, 'temaOrden', this['temaOrden' + contadorTemas]);
                        ...
                        childSnapshot.forEach(function(childSnapshot2) {
                            ...
                            if (childSnapshot2.key == "Recursos") {
                                ...
                                // console.log('cuantosRecursos del Curso', cualCurso, 'Tema', this['temaOrden' + contadorTemas], this['cuantosRecursosTemaCurso' + contadorTemas]);
                                ...
                                childSnapshot2.forEach(function(childSnapshot3) {
                                    ...
                                    console.log('recursoTemaCursoPuntosObtener', this['recursoTemaCursoPuntosObtener' + contadorRecursosPorTema]);
                                    ...
                                    console.log('recursoTemaCursoTipoEntrega', this['recursoTemaCursoTipoEntrega' + contadorRecursosPorTema]);
                                    this['recursoTemaCursoCalifAuto' + contadorRecursosPorTema] = childSnapshot2.child(childSnapshot3.key).child('CalifAutomatica').val();
                                    console.log('recursoTemaCursoCalifAuto', this['recursoTemaCursoCalifAuto' + contadorRecursosPorTema]);
                ...
                console.log('cuantosTemasCur', cuantosTemasCur);
                thas = this;
            ...
            if (snapshot.val() != null) {
                snapshot.forEach(function(childSnapshot) {
                    ...
                    if (childSnapshot.key != undefined && childSnapshot.key != null && childSnapshot.key != '' && childSnapshot.key != 'undefined' && childSnapshot.key != 'val') {
                        ...
                        console.log(contadorRecursos, 'recursoId', this['recursoId' + contadorRecursos]);
                        this['recursoClave' + contadorRecursos] = snapshot.child(childSnapshot.key).child('Clave').val();
                        console.log(contadorRecursos, 'recursoClave', this['recursoClave' + contadorRecursos]);
                        this['recursoNombre' + contadorRecursos] = snapshot.child(childSnapshot.key).child('Nombre').val();
                        // console.log(contadorRecursos, 'recursoNombre', this['recursoNombre' + contadorRecursos]);
                        this['recursoLiga' + contadorRecursos] = snapshot.child(childSnapshot.key).child('Liga').val();
                        // console.log(contadorRecursos, 'recursoLiga', this['recursoLiga' + contadorRecursos]);
                        this['recursoCategoria' + contadorRecursos] = snapshot.child(childSnapshot.key).child('Categoria').val();
                        // console.log(contadorRecursos, 'recursoCategoria', this['recursoCategoria' + contadorRecursos]);

                        // descripción no necesaria
                        // this['recursoDescripcion' + contadorRecursos] = snapshot.child(childSnapshot.key).child('Descripcion').val();
                        // console.log(contadorRecursos, 'recursoDescripcion', this['recursoDescripcion' + contadorRecursos]);
                        // descripción no necesaria
                        ...
                        console.log(contadorRecursos, 'recursoTipoEntrega', this['recursoTipoEntrega' + contadorRecursos]);
                        this['recursoInstrucciones' + contadorRecursos] = snapshot.child(childSnapshot.key).child('Instrucciones').val();
                        console.log(contadorRecursos, 'recursoInstrucciones', this['recursoInstrucciones' + contadorRecursos]);
                ...
                console.log('cuantosRecursosCur', cuantosRecursosCur);
                those = this;
                // return pintaUsuariosAsig();
            }
        });
    ...
    if (revisaConexion) {
        ...
        firebase.database().ref(elRefRevisado).once('value').then(function(snapshot) {
            if (snapshot.val() != null) {
                ...
                console.log('Curso Revisado: ', cursoEstatus);
...
function pintaUsuariosAsig() {
    ...
    for (a = 0; a < arrayUsuarios.length; a++) {
        dataSetUsuAsig[a] = [
            '<div id="botoninscribirAlumno' + a + '" usuarioasigid="' + arrayUsuarios[a].usuarioId + '" class="btn btn-sm btn-toggle btn-inscribirAlumno" data-toggle="button">' +
            ...
            '<div id="botonResetearAlumno' + a + '" usuid="' + arrayUsuarios[a].usuarioId + '" class="btn btn-round btn-icon btn-sm btn-primary botonEliminarUsuario"><i class="nc-icon-outline ui-1_trash-simple" style="margin-top: 6px;"></i></div>'
        ];
    }
    console.log('dataSetUsuAsig ', dataSetUsuAsig);
        ...
        tablaUsuariosAsig = $('#tablaUsuariosAsig').DataTable({
            ...
            "initComplete": function(settings) {
                ...
                function recalculaUsuAsig() {
                    for (c = 0; c <= cuantosUsuarios; c++) {
                        // console.log('cuantosUsuariosAsignados', that['cuantosAsignados' + cursoEditandoNum]);
                        for (d = 1; d <= that['cuantosAsignados' + cursoEditandoNum]; d++) {
                            // console.log('cursoUsuAsigId', c, that['cursoUsuAsigId' + d + '_' + cursoEditandoNum]);
                            // console.log('botoninscribirAlumno', c, $('#botoninscribirAlumno' + c).attr('usuarioasigid'));

                            if ($('#botoninscribirAlumno' + c).attr('usuarioasigid') == that['cursoUsuAsigId' + d + '_' + cursoEditandoNum]) {
                                // console.log('cuantosUsuariosAsignados', that['cursoUsuAsigId' + d + '_' + cursoEditandoNum], $('#botoninscribirAlumno' + c).attr('usuarioasigid'));

                                $('#botoninscribirAlumno' + c).addClass('active');
                            }
                        }
                    }
                }
                ...
                for (d = 0; d <= cuantosUsuarios; d++) {
                    $(document).off('click', '#botonResetearAlumno' + d).on('click', '#botonResetearAlumno' + d, function(event) {
                        event.preventDefault();
...
function pintaProfesorAsig() {
    ...
    for (a = 0; a < arrayProfesores.length; a++) {
        dataSetProfAsig[a] = [
            '<div id="botoninscribirProfesor' + a + '" profesorasigid="' + arrayProfesores[a].usuarioId + '" class="btn btn-sm btn-toggle btn-inscribirProfesor" data-toggle="button">' +
            '    <div class="handle"></div>' +
            '</div>',
            ...
            // arrayProfesores[a].usuarioGrupo
            '<div id="botonResetearProfesor' + a + '" profesorasigid="' + arrayProfesores[a].usuarioId + '" class="btn btn-round btn-icon btn-sm btn-primary botonEliminarUsuario"><i class="nc-icon-outline ui-1_trash-simple" style="margin-top: 6px;"></i></div>'
        ];
    }
    console.log('dataSetProfAsig ', dataSetProfAsig);
    ...
    setTimeout(function() {
        ...
        tablaProfesorAsig = $('#tablaProfesorAsig').DataTable({
            ...
            "initComplete": function(settings) {
                ...
                tablaProfesorAsig.rows().every(function() {
                    this.child(
                ...
                for (a = 0; a <= cuantosProfesores; a++) {
                    ...
                    $('#botoninscribirProfesor' + a).parent().parent().next().addClass('row_mostrar_grupo');

                    $(document).off('click', '#botoninscribirProfesor' + a).on('click', '#botoninscribirProfesor' + a, function(event) {
                        event.preventDefault();
                        // var cualProfRow = parseInt($(this).attr('id').substr(22, 3));
                        // console.log('inscribirProfesor', cualProfRow);
                ...
                function recalculaProfAsig() {
                    for (c = 0; c <= cuantosUsuarios; c++) {
                        ...
                        for (d = 1; d <= that['cuantosAsignados' + cursoEditandoNum]; d++) {
                            // console.log('cursoUsuAsigId', c, that['cursoUsuAsigId' + d + '_' + cursoEditandoNum]);
                            // console.log('botoninscribirProfesor', c, $('#botoninscribirProfesor' + c).attr('profesorasigid'));

                            if ($('#botoninscribirProfesor' + c).attr('profesorasigid') == that['cursoUsuAsigId' + d + '_' + cursoEditandoNum]) {
                                // if (elPerfil === 'Asesor académico') {
                                //     console.log('cuantosProfesoresAsignados', that['cursoUsuAsigId' + d + '_' + cursoEditandoNum], $('#botoninscribirProfesor' + c).attr('profesorasigid'));
                                // }
                                $('#botoninscribirProfesor' + c).addClass('active');
                                $('#botoninscribirProfesor' + c).parent().parent().next().addClass('row_mostrar_grupo_activo');
                                $('#botoninscribirProfesor' + c).parent().parent().next().find('.row_mostrar_grupo_div').removeClass('row_mostrar_grupo_div_inactivo');


                                // if (elPerfil === 'Asesor académico') {
                                // console.log('ooooooo', that['cursoUsuGrupos' + d + '_' + cursoEditandoNum]);
                                // if ($('#botoninscribirProfesor' + c).attr('profesorasigid') == that['cursoUsuGrupos' + d + '_' + cursoEditandoNum]) {
                                // $('#botoninscribirProfesor' + c).parent().parent().next().next().find('#botonGrupo' + c).addClass('active');
                                // }
                                // }
                ...
                if (!modoAgregar) {
                    ...
                    $(document).off('click', '#tablaProfesorAsig_length > label > select').on('click', '#tablaProfesorAsig_length > label > select', function(e) {
                        recalculaProfAsig();
                    });

                    // for (c = 0; c <= cuantosProfesores; c++) {
                    //     // console.log('cursoUsuAsigId', that['cursoUsuAsigId' + d]);
                    //     // console.log('cursoUsuAsigId', cursoEditandoNum, cursoEditandoId, that['cuantosAsignados' + cursoEditandoNum], that['cursoUsuAsigId' + c + '_' + cursoEditandoNum], $('#botoninscribirProfesor' + c).attr('profesorasigid'));
                ...
                for (d = 0; d <= cuantosProfesores; d++) {
                    $(document).off('click', '#botonResetearProfesor' + d).on('click', '#botonResetearProfesor' + d, function(event) {
                        event.preventDefault();
...
function subirPortadaCurso(divInput) {
    console.log("[SUBIENDO PORTADA]", divInput);
    ...
    if (elInput) {
        ...
        console.log("formData", divInput.files[0]);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                console.log("Portada agregada exitosamente");
...
function subirCurso() {
    console.log("[SUBIENDO CURSO]", elCursoIndex, modoAgregar);
    cargador('muestra');
    ...
    temas.val = true;
    cuantosTemas = $('.temas_int > .wrap_tema').length;
    console.log('cuantosTemas', cuantosTemas);
    ...
    if (arrayUsuarios.length > 0) {
        ...
        for (c = 0; c <= arrayUsuarios.length; c++) {
            ...
            if ($('#botoninscribirAlumno' + c).hasClass('active')) {
                cuantasInscripciones++;
                this['usuInscId' + c] = $('#botoninscribirAlumno' + c).attr('usuarioasigid');
                console.log('cuantasInscripciones', cuantasInscripciones, this['usuInscId' + c]);

                asignacion[this['usuInscId' + c]] = {};
                asignacion[this['usuInscId' + c]].val = true;
                asignacion[this['usuInscId' + c]].Id = this['usuInscId' + c];
                ...
                asignacion[this['usuInscId' + c]].Grupos = arrayUsuarios[c].usuarioGrupo;

            }
        }
    }
    console.log('ASIGNACIÓN USUARIOS', asignacion);
    ...
    for (c = 0; c <= arrayProfesores.length; c++) {
        // cuantasInscripciones += $('#botoninscribirAlumno' + c).hasClass('active');
        if ($('#botoninscribirProfesor' + c).hasClass('active')) {
            cuantasInscripciones++;
            this['ProfInscId' + c] = $('#botoninscribirProfesor' + c).attr('profesorasigid');
            console.log('cuantasInscripciones', cuantasInscripciones, this['ProfInscId' + c]);

            asignacion[this['ProfInscId' + c]] = {};
            asignacion[this['ProfInscId' + c]].Id = this['ProfInscId' + c];
            ...
            for (d = 0; d <= cuantosGrupos; d++) {
                if ($('#botoninscribirProfesor' + c).parent().parent().next().next().find('#botonGrupo' + d).hasClass('active')) {
                    // console.log('Grupos', arrayGrupos[d]);
    ...
    console.log('ASIGNACIÓN PROFESORES', asignacion);
    // Inscripciones //
...
function guardaCursoBD(elCurso) {
    console.log("guardaCursoBD", elCurso);
    ...
    if (revisaConexion) {
        ...
        console.log('elRefNuevoCurso: ', elRefNuevoCurso);
...
function eliminaCursoBD(cursoEliminar) {
    console.log('eliminaCursoBD: ', cursoEliminar);
    ...
    if (revisaConexion) {
        ...
        console.log('elRefEliminaCurso: ', elRefEliminaCurso);
...
function eliminaDirectorioCurso(cualCurso) {
    console.log("eliminaDirectorio", cualCurso, that['cursoId' + cualCurso]);
...
function eliminaCurso(cualCurso) {
    console.log("eliminaCurso", cualCurso);
...
function inscribirAlumno(cualUsuario, cualUsuarioId) {
    // console.log("inscribirAlumno", cualUsuario);

    // var aInscribir = !$('#botoninscribirAlumno' + cualUsuario).hasClass('active');
    // console.log('inscribirAlumno', cualUsuario, cualUsuarioId, aInscribir);
...
function resetearAvance(cualUsuario) {
    console.log('resetearAvance', cualUsuario, cursoEditandoId);
    ...
    $(document).off('click', '#botonAceptarResetearAvance').on('click', '#botonAceptarResetearAvance', function(event) {
        ...
        if (revisaConexion) {
            ...
            console.log('elRefEliminaAvance: ', elRefEliminaAvance);
...
function ajustaCalifTotal() {
    ...
    // console.log('cuantosCalifRecurso', cuantosCalifRecurso);
    var _valRestante = 0;
    ...
    function handleInputChange(e) {
        ...
        $('input[type="range"]').each(function(index, value) {
            // console.log('value', index, Math.round(this.value));
            ...
            // console.log(totalCalifRecursos);
        });
        valRestante = (califMaxima - totalCalifRecursos);
        // console.log('totalCalifRecursos', totalCalifRecursos);
    ...
    function calculaRest(e) {
        ...
        $('input[type="range"]').each(function(index, value) {
            ...
            // console.log('valueMinEach', index, _totalCalifRecursos);
        });

        _totalCalifRecursosMin = (_totalCalifRecursos - Math.round(this.value));
        // console.log('valueMin', _totalCalifRecursos, _totalCalifRecursosMin);
        _valRestante = (califMaxima - _totalCalifRecursosMin);
        console.log('_valRestante', _valRestante);
    }
