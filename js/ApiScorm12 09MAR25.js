function inicializaAPI() {
    ...
    function leeDatosSCORM() {
        ...
        var onComplete = function(error) {
            if (error) {
                log('Ocurrió un error al leer los datos SCORM.');
            } else {
                log('Se leyeron los datos SCORM con éxito.');
            }
        };
        ...
        if (revisaConexion) {
            ...
            firebase.database().ref(elRefDatos).once('value').then(function(snapshot) {
                ...
                log('f_session_time: ', f_session_time);
                ...
                log('f_suspend_data: ', f_suspend_data);
    ...
    function escribeDatosSCORM(param, val) {
        log('escribeDatosSCORM', param, 'val', val);

        var nuevoParam = param.split('.').join('_');
        log('nuevoParam', nuevoParam);

        var onComplete = function(error) {
            if (error) {
                log('Ocurrió un error al ecribir los datos SCORM.');
            } else {
                // leeDatosSCORM();
                ...
                actualizaTemas();
                log('Se escribieron los datos SCORM con éxito.');
            }
        };
        ...
        if (revisaConexion) {
            ...
            log('elRefDatos a escribir: ', elRefDatos);
            ...
            firebase.database().ref(elRefDatos).once('value').then(function(snapshot) {
                ...
                log('paramActual', paramActual, val);
                ...
                firebase.database().ref().update(updates, onComplete);
                log('escrito:', nuevoParam, 'y', elVal)
    ...
    function LMSGetValue(param) {
        ...
        if (param == 'cmi.core._children' || param == 'cmi.core_children') {
            ...
            // }
            log('Get f_lesson_status', f_lesson_status);
            ...
            log('Get f_lesson_location', f_lesson_location);
    ...
    function LMSSetValue(param, val) {
        ...
        // log('elResult_lesson_status', elResult_lesson_status);

        // var elResult_suspend_data = LMSGetValue('cmi.suspend_data');
        // log('elResult_suspend_data', elResult_suspend_data);

        // var lesson_status_registrado = elResult_lesson_status;
        // log('lesson_status_registrado', lesson_status_registrado);
        ...
        if (param == "cmi.core.score.raw") {
            ...
            log('elResult_score_raw', elResult_score_raw);
            ...
            // log('elResult_lesson_location', elResult_lesson_location);
